...
// Database
import Database_Manisha_tutorial_db from "./Database_Manisha_tutorial_db.js";

// Controllers
import UserController from "../controllers/Manisha_tutorial_db/UserController";
import LoginpageController from "../controllers/Manisha_tutorial_db/LoginpageController";
...
class Server {
  ...
  async init() {
    ...
    // Start Init Database
		Database_Manisha_tutorial_db.init();
 // End Init Database
    ...
    // Start Init Controllers
		...
		LoginpageController.init(router);
